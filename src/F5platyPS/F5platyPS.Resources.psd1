...
PlatyPS100SchemaDeprecated = F5PlatyPS schema version 1.0.0 is deprecated and not supported anymore. Please install F5platyPS 0.7.6 and migrate to the supported version.
...
FailedSettingFileSystemProvider = F5PlatyPS Cmdlets only work in the FileSystem Provider. Failed setting provider back to FileSystem.
...
SettingFileSystemProvider = F5PlatyPS Cmdlets only work in the FileSystem Provider. F5PlatyPS is changing the provider of this session back to FileSystem.
